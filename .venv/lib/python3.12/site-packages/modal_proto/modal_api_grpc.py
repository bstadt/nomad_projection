...
class ModalClientModal:
    ...
    def __init__(self, grpclib_stub: modal_proto.api_grpc.ModalClientStub, client: "modal.client._Client", server_url: str) -> None:
        ...
        self.AppPromote = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.AppPromote, client, server_url)
        ...
        self.EnvironmentSetDefaultMemberRole = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EnvironmentSetDefaultMemberRole, client, server_url)
        ...
        self.FunctionGetTimeRangeStats = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.FunctionGetTimeRangeStats, client, server_url)
        ...
        self.ImageBuildChainGet = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.ImageBuildChainGet, client, server_url)
        ...
        self.SandboxCreateConnectTokenV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxCreateConnectTokenV2, client, server_url)
        ...
        self.SandboxGetExitSnapshotV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxGetExitSnapshotV2, client, server_url)
        ...
        self.UserGroupEnvironmentSet = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.UserGroupEnvironmentSet, client, server_url)
        ...
        self.WorkspaceBillingRates = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WorkspaceBillingRates, client, server_url)

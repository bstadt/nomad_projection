...
FunctionGetTimeRangeStatsRequest = _reflection.GeneratedProtocolMessageType('FunctionGetTimeRangeStatsRequest', (_message.Message,), {
  'DESCRIPTOR' : _FUNCTIONGETTIMERANGESTATSREQUEST,
  '__module__' : 'modal_proto.api_pb2'
  # @@protoc_insertion_point(class_scope:modal.client.FunctionGetTimeRangeStatsRequest)
  })
